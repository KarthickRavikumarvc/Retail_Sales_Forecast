...
def streamlit_config():
    ...
    st.markdown(f"""<h4 style="text-align: justify;">Retail Sales Forecast employs advanced machine learning techniques, prioritizing careful data preprocessing, 
...
class sql:
    ...
    def create_table():
        ...
        try:
            ...
            Karthick = psycopg2.connect(host='localhost',
                                    user='postgres',
                                    password='karthick',
                                    database='retail_forecast')
            cursor = Karthick.cursor()
    ...
    def data_migration():
        ...
        try:
            f = pd.read_csv(r'D:\Guvi_Projects\Retail_sales_forecast_Final-project\dataset\df_sql.csv')
            df = pd.DataFrame(f)
    ...
    def predict_weekly_sales():
        ...
        if button:
            with st.spinner(text='Processing...'):
                ...
                with open(r'D:\Guvi_Projects\Retail_sales_forecast_Final-project\dataset\model1_markdown.pkl', 'rb') as f:
                    model = pickle.load(f)
